...
DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://abc132596:Mkjadeja1910@cluster0.nmhtowy.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp").strip()
